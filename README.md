...
- [Exams](#exams)
- [Featured Standalone Repositories](#featured-standalone-repositories)
- [Piscine](#piscine)
...
| [Exam Rank 05](tronc-commun-42/exam/exam_rank_05) | Python — run-length compression, graph cycle detection, meeting scheduling, spiral matrix | `Python` | **100/100** |

## Featured Standalone Repositories

Flagship projects are also published as **standalone repositories** (pinned on my profile):
...
- [**pac-man-42**](https://github.com/Sabofxx/pac-man-42) — Pac-Man remake in pygame, autonomous ghost AI, procedural mazes
...
- **Algorithm design** — sorting (radix, chunk-based), pathfinding (Dijkstra), graph traversal (DFS/BFS), cycle detection, interval scheduling, sliding window
...
**omischle** @ 42 · [GitHub](https://github.com/Sabofxx) · [42 Profile](https://profile.intra.42.fr/users/omischle)
